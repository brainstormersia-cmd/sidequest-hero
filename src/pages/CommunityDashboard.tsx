      ...
      <div className="flex items-start justify-between mb-2 sm:mb-3">
        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
            <span className="text-base sm:text-lg">{mission.mission_categories?.icon || '⭐'}</span>
          </div>
...
const CommunityDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              {!isGuest && profile && (
                <Card className="bg-primary text-primary-foreground px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl shadow-floating border-0">
      ...
      <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 pb-24">
        {/* Quick Actions */}
        <section>
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            ...
            {topUsers.length > 0 && (
              <div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  {topUsers.slice(0, 2).map((user, index) => (
        ...
        {/* Guest CTA */}
        {isGuest && (
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 text-center">
